...
Function: whole_chrom_codons
Input: none calling the function returns the information
Output: dictionary containing all the codons as keys and there frequencies as the attached values. The key 'total' contains
information on how many codons there are in total. This was generated by the program inside the whole_codon_calc directory.
